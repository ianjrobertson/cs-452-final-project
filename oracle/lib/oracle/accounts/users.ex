defmodule Oracle.Accounts.Users do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Oracle.Repo)
  ...
  """
  def valid_password?(%Oracle.Accounts.Users{hashed_password: hashed_password}, password)
